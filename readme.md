...
A cute, narrative-driven browser based 3d puzzle platformer that lets you explore the human world as a curious (sometimes equally destructive) feline!

_(Big special thanks to [the team](https://github.com/orgs/BabylonJS/people) over at [BabylonJS](https://www.babylonjs.com/) for creating such incredibly versatile tools for web-based game development!)_

<br>
<img src="res/assets/render2%20warm.png" width="80%" alt="Description">
<img src="res/assets/render1%20cold.png" width="80%" alt="Description">

_(Early concept art)_
...
<br>
And that's really it, that's all you need to do!  
...
_**Note:** If you would like the .css output to be minified OR you want to keep the generated `.map` files: alter the "Arguments" field and add `--style=compressed` to enable minification, and delete `--no-source-map` to re-enable source map generation as desired.  
**ALSO** if you decide to create multiple watchers, ensure only one is enabled at a time. You may also want to change the name of each File Watcher to reflect what each one is for._
